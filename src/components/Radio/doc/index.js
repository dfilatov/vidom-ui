...
export default function RadioDoc({ tab, onTabChange }) {
    return (
        <DocComponent title="Radio">
                ...
                <DocTab title="API" value="api">
                    <DocAttrs>
                        <DocAttr name="checked" type="Boolean" def="false">
                            Checks the radio if set to <DocInlineCode>true</DocInlineCode>.
                        </DocAttr>
                        <DocAttr name="disabled" type="Boolean" def="false">
                            Disables the radio if set to <DocInlineCode>true</DocInlineCode>.
                        </DocAttr>
                        <DocAttr name="focused" type="Boolean" def="false">
                            Focuses the radio if set to <DocInlineCode>true</DocInlineCode>.
                        </DocAttr>
                        ...
                        <DocAttr name="text" type="String">
                            The text to display for the radio.
                        </DocAttr>
                        <DocAttr name="theme" type="String" required>
                            Sets the radio theme.
                        </DocAttr>
