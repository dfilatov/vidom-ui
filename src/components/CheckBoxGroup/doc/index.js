...
export default function CheckBoxGroupDoc({ tab, onTabChange }) {
    return (
        <DocComponent title="CheckBoxGroup">
                ...
                <DocTab title="API" value="api">
                    <DocAttrs>
                        ...
                        <DocAttr name="theme" type="String" required>
                            Sets the theme for the child checkboxes.
                        </DocAttr>
                    ...
                    <DocChildren>
                        <DocText>
                            Each child is expected to be a <DocInlineCode>&lt;CheckBox/&gt;</DocInlineCode>.
                            Following attributes of <DocInlineCode>&lt;CheckBox/&gt;</DocInlineCode> are filled automatically by <DocInlineCode>&lt;CheckBoxGroup/&gt;</DocInlineCode>: <DocInlineCode>checked</DocInlineCode>, <DocInlineCode>name</DocInlineCode>, <DocInlineCode>size</DocInlineCode>, <DocInlineCode>theme</DocInlineCode>, <DocInlineCode>type</DocInlineCode>.
                        </DocText>
                    </DocChildren>
                </DocTab>
            </DocTabs>
